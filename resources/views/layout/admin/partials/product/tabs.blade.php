                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="general-v">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input value="{{ old('pro_price') }}" class="form-control" name="pro_price">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input value="{{ old('spl_price') }}" class="form-control" name="spl_price">
                            ...
                            <div class="wap_att">
                                ...
                                @foreach($sizes as $size)
                                    <div class="form-check form-check-inline">
                                        <input name="size[]" class="form-check-input" type="checkbox" id="size-{{$size->name}}" value="{{ $size->id }}">
